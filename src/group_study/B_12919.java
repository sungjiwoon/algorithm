...
public class B_12919 {
    ...
    public static void main(String[] args) throws IOException{
        ...
        1) HashSet 을 통해 이미 검사했던 문자열이 또 들어오면 return 하게 했다.
        2) 문자열 끝에 'A' 가 있다면 A를 없애는 조건을 걸어 재귀를 돌렸다.
        3) 문자열을 뒤집어 끝에 'B' 가 있다면 B를 없애는 조건을 걸어 재귀를 돌렸다.

        String 대신 StringBuilder를 사용한 이유 : StringBuilder는 내부적으로 가변적인 char[]을 사용하므로 String 보다 문자열을 변경, 삽입하는데
        훨씬 시간이 덜 소요된다.
